...
const { courses, course, generateCourseContent, isGeneratingCourseName, hasGeneratedCourseName } = useCourse()
            ...
            <UCard :ui="{ ring: '', divide: 'divide-y divide-gray-100 dark:divide-gray-800' }">
                ...
                <form class=" h-[300px] flex flex-col items-center justify-center">
                    <div class="w-full space-y-4">
                        <UFormGroup label="Technology" name="course">
                            <USelectMenu :loading="loadingTags" searchable searchable-placeholder="Search a Technology"
                        ...
                        <UFormGroup label="Course Level" name="level">
                            <USelect :options="['Beginner', 'Intermediate', 'Advanced']" v-model="selectedLevel" />
                        </UFormGroup>
